...
\chapter{GIỚI THIỆU CHUNG}
	...
	Mã nguồn của bài toán Nhận diện tin giả có thể được tích hợp thành các module sử dụng trên nền tảng web, đặc biệt là các trang báo điện tử không chính thống. Qua đó có thể xác định, kiểm soát và ngăn chặn kịp thời tin giả, tin sai lệch lây lan trên không gian mạng, góp phần mang lại sự ổn định trong cộng đồng, củng cố niềm tin của người dân và uy tín của các tổ chức xã hội.
...
\chapter{TỔNG QUAN VỀ BỘ DỮ LIỆU}
	...
	Bộ dữ liệu được chia sẻ bởi nhiều nguồn khác nhau trên nền tảng Kaggle. Thông qua tìm hiểu, chúng tôi tìm thấy được bộ dữ liệu gốc của tác giả Raluca Chitic đăng tải vào ngày 23/05/2018. Tại thời điểm đó, tác giả đã được trích dẫn là chủ nhân của bộ dữ liệu trong một số bài báo nghiên cứu (\href{https://www.researchgate.net/publication/339299161_Application_of_Supervised_Machine_Learning_Algorithms_to_Detect_Online_Fake_News}{\textit{Application of Supervised Machine Learning Algorithms to Detect Online Fake News}}).
	...
	\begin{table}[h!]
		\begin{center}
			...
			\begin{tabular}{c|l}
				...
				\end{tabular}\\
				\hline
				Thông tin Tác giả & Raluca Chitic
			\end{tabular}
...
Qua kết quả đánh giá tổng hợp thu được có thể thấy mô hình PassiveAgressiveClassifier cho hiệu suất cao nhất trên bộ TfidfVectorizer.

\subsection{Lỗi False Positive}

\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{fp1gram}
	\caption{Những từ Unigram xuất hiện nhiều ở lỗi False Positive}
\end{figure}



\subsection{Lỗi False Negative}
\begin{figure}[H]
	\centering
	\includegraphics[width=0.8\textwidth]{fn1gram}
	\caption{Những từ Unigram xuất hiện nhiều ở lỗi False Negative}
\end{figure}

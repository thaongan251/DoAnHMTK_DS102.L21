...
\chapter{TỔNG QUAN VỀ BỘ DỮ LIỆU}
	...
	Rahul Patodi (link drive thầy gửi) <--- ông này chỉ viết blog tổng hợp các dataset lên drive ổng (?)
	...
	\begin{table}[h!]
		\begin{center}
			...
			\begin{tabular}{c|l}
				...
				\hline
				Nguồn dữ liệu & \url{https://www.kaggle.com/hassanamin/textdb3}\\
				\hline
				...
				\begin{tabular}{l}
					...
					\tabitem REAL: Đây là tin tức giả\\
				\end{tabular}\\
				\hline
...
\chapter{HUẤN LUYỆN VÀ TINH CHỈNH CÁC MÔ HÌNH HỌC MÁY}
	\section{Cơ sở lý thuyết}
		...
		\item \textbf{early\_stopping:} Nếu nhận giá trị True, mô hình sẽ tự động dừng huấn luyện nếu kết quả thẩm định không cải thiện.
		\end{itemize}
			...
			\renewcommand{\arraystretch}{1.5}
			{
				...
				\begin{center}
					\begin{tabular}{ |m{3.4cm}|m{3.7cm}|m{3.7cm}|m{3.7cm}|}
						...
						\hline 
						\multirow{2}{2em}{\textbf{LogisticRegression}} & solver = sag & solver = saga & solver = newton-cg \\
						& C = 1 & C = 1000 &C = 10 \\ 
						\hline 
						\multirow{2}{4em}{\textbf{MultinomialNB}} & alpha = 0.1 & alpha = 0.1 & alpha = 1.1 \\ 
						...
						\hline
						\multirow{2}{4em}{\textbf{PassiveAgressive\\Classifier}} & C = 0.001 & C = 0.1 &C = 0.001 \\
						...
						\hline 
						\multirow{6}{4em}{\textbf{RadomForest\\Classifier}} & criterion = entropy & criterion = gini & criterion = entropy  \\
...
\chapter{ĐÁNH GIÁ HIỆU SUẤT MÔ HÌNH}
	...
	\subsection{Confusion Matrix}
		...
		\item \textbf{False Negative (FN):} số điểm dữ liệu có nhãn là Negative được dự đoán là Positive.
...
\begin{table}[H]
	...
	\subfloat[\textbf{Word2Vec}]{% 
		...
		\hline
	      & precision & recall & f1-score & support \\ 
		\hline
		0 & 0.81 & 0.81 & 0.81 & 794\\
		\hline
		1 & 0.81 & 0.81 & 0.81 & 790\\ 
		\hline
...
\begin{table}[H]
	...
	\subfloat[\textbf{Word2Vec}]{% 
		...
		\hline
	      & precision & recall & f1-score & support \\ 
		\hline
		0 & 0.94 & 0.92 & 0.93 & 794\\
		\hline
		1 & 0.92 & 0.94 & 0.93 & 790\\ 
		\hline
...
\begin{table}[H]
	...
	\subfloat[\textbf{TfidfVectorizer}]{% 
		...
		\hline
	      & precision & recall & f1-score & support \\ 
		\hline
		0 & 0.97 & 0.96 & 0.96 & 794\\
		\hline
		1 & 0.96 & 0.97 & 0.96 & 790\\ 
		\hline
	...
	\subfloat[\textbf{Word2Vec}]{% 
		...
		\hline
	      & precision & recall & f1-score & support \\ 
		\hline
		0 & 0.93 & 0.89 & 0.91 & 794\\
		\hline
		1 & 0.89 & 0.93 & 0.91 & 790\\ 
		\hline
